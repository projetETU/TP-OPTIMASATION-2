		...
		<div class="categolis">
			<table>
				<tr>
					...
					<th><?php echo '<a aria-label="Read more about Seminole tax hike" href="settings.php?uid='.$user.'" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Settings</a>'; ?></th>
